...
def insertCSVlineIntoTable():
    # SQL command:  You have to implement a SQL command below according to the Afleveringsopgave CSV to DB
    sql_command = """To be implemented here - Good luck"""
